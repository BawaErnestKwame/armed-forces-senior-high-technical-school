...
const inputCls = `
  ...
  placeholder:text-[#9ca3af] bg-white/5 backdrop-blur-sm
...
const Contact = () => {
  ...
  const fieldStyle = (name) => ({
    borderColor: focused === name ? "#E63946" : "rgba(255,255,255,0.2)",
  ...
  return (
    <div>
      ...
      {/* ══ FORM + MAP ══════════════════════════════════════════════════════ */}
      <section className="py-10" style={{ background: C.lightGray }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-3 relative z-10">
                <span className="text-[12px] font-bold text-[#E63946] tracking-[2px] uppercase">
                  Get In Touch
                </span>
              ...
              <p className="text-[14px] mb-8 text-gray-300 relative z-10">
                Have a question or want to know more about AMESCO? Fill in the
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option className="text-gray-800">Fees & Finance</option>
                      <option className="text-gray-800">Alumni Affairs</option>
                  ...
                  {[
                    {
                      num: "01",
                      title: "Location",
                      body: "Old Uaddara Barracks, Bantama, Kumasi, Ashanti Region, Ghana.",
                    },
                    {
                      num: "02",
                      title: "Directions",
                      body: "Located near the Kumasi Military Barracks. Take the Bantama road from Kejetia and look for the AMESCO signage.",
                    },
                    {
                      num: "03",
                      title: "Parking",
